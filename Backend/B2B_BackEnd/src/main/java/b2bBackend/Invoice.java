...
public class Invoice
{
	...
	public void setSerialNo(int sl_no) {
		this.sl_no=sl_no;
	}
	...
	public String getBuisnessYear() {
		return buisness_year;
	}
	public void setBuisnessYear(String buisness_year) {
	...
	public void setDocumentCreateDate1(String document_create_date1) {
	...
	public String toString() {
		String res = business_code + ", " + cust_number + ", "  + clear_date + ", " + buisness_year + ", " + doc_id + ", " + posting_date + ", " + document_create_date + ", " + document_create_date1 + ", "+due_in_date + ", " + invoice_currency + ", " + document_type + ", " + posting_id + ", " +area_business+ total_open_amount + ", " + baseline_create_date + ", " + cust_payment_terms + ", " + invoice_id + ", " + isOpen + ","+is_deleted +"\n";
